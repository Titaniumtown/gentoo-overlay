...
inherit autotools check-reqs flag-o-matic java-pkg-2 java-vm-2 multiprocessing pax-utils toolchain-funcs git-r3
...
EGIT_REPO_URI="https://github.com/openjdk/jdk${SLOT}u"
EGIT_BRANCH="master"
